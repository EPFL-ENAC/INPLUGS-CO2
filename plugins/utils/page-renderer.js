...
export class PageRenderer {
  ...
  async renderOne({ relTemplate, baseRel, locale, availableLocales, localeData, routesConfig, metaData }) {
    ...
    try {
      ...
      html = rewriteLinksWithRoutes(html, locale, routesConfig, this.linkRewrite)
